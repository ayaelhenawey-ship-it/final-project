...
exports.googleAuthCallback = exports.register = exports.login = void 0;
...
exports.googleAuthCallback = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    if (!req.user)
        return next(new AppError_1.AppError('Google login failed', 401));
    const token = authService.signToken(req.user._id.toString());
